...
namespace Buffet.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult StatusEvento()
        {
            ...
            // Status dos Eventos
            var listaStatusEventos = new List<SituacaoEvento>();
            listaStatusEventos.Add(new SituacaoEvento()
            {
                Id = 1,
                Descricao = "Reservado"
            });
            ...
            foreach (SituacaoEvento statusEvento in listaStatusEventos) {
        ...
        public IActionResult StatusConvidado()
        {
            ...
            var listaStatusConvidado = new List<SituacaoConvidado>();
            listaStatusConvidado.Add(new SituacaoConvidado()
            {
                Id = 1,
            ...
            // Alimento a view model com os dados dos status
            foreach (SituacaoConvidado statusConvidado in listaStatusConvidado) {
                viewmodel.ListaDeStatus.Add(new Status()
                {
